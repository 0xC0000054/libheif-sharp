...
namespace LibHeifSharp
{
    ...
    internal readonly struct HeifPropertyId : IEquatable<HeifPropertyId>
    {
        ...
        {
            return obj is HeifPropertyId other && Equals(other);
        }
        ...
        /// </returns>
        public bool Equals(HeifPropertyId other)
        {
        ...
        /// </returns>
        public static bool operator ==(HeifPropertyId left, HeifPropertyId right)
        {
