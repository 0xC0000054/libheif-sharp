...
namespace LibHeifSharp
{
    ...
    public sealed class RegionPolygon : RegionGeometry
    {
        private readonly ReadOnlyCollection<PolygonPoint> points;

        /// <summary>
        /// Initializes a new instance of the <see cref="RegionPolygon"/> class.
        /// </summary>
        ...
        /// </exception>
        internal RegionPolygon(heif_region region) : base(RegionGeometryType.Polygon)
        {
            ...
            if (count > 0)
            {
                ...
                try
                {
                    ...
                    unsafe
                    {
                        ...
                        {
                            var error = LibHeifNative.heif_region_get_polygon_points(region, ptr);
                            error.ThrowIfError();
                        }
                    }
